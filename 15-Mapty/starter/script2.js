...
class Workout {
  date = new Date();
  id = (Date.now() + '').slice(-10); //in real world is recommended to use a library for ids
  //clicks = 0;
...
class App {
  ...
  constructor() {
    ...
    inputType.addEventListener('change', this._toggleElevationField); //this keyword não é utilizada em _toggleElevationField por isso não é necessário usar bind
  ...
  _renderWorkout(workout) {
    let html = `
          <li class="workout workout--${workout.type}" data-id="${workout.id}">
            ...
            <button class="workout__delete workout__details">X</button>
  ...
  // //   const deleteWorkout = this._findWorkout(event);
...
// // deleteWorkout.addEventListener('click', this._removeWorkout.bind(this));
